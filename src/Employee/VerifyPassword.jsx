...
export default function VerifyPassword() {
    return(
        <div>
            <div>
                <div className="go-back"><Link to='/settings'><svg  xmlns="http://www.w3.org/2000/svg" fill="currentColor"  width="50" height="50" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" enableBackground="new 0 0 100 100" xmlSpace="preserve"><path d="M64.916,84.833c-1.279,0-2.56-0.488-3.535-1.465L28.013,50l33.368-33.369c1.951-1.952,5.119-1.952,7.07,0  c1.953,1.953,1.953,5.119,0,7.071L42.155,50l26.296,26.298c1.953,1.952,1.953,5.118,0,7.07  C67.476,84.345,66.195,84.833,64.916,84.833z"/></svg></Link></div>
