...
import Clientcompanylogo from './Clientcompanylogo.js';
const SignInForm = () => {
  return (
    <div>
    <Brandbar/>
    ...
    <div className="container-signup">
      ...
      <form action="project\src\Home.js" className="form">
        
        <input className="input" type="email" name="email" id="email"  placeholder="Username" />
